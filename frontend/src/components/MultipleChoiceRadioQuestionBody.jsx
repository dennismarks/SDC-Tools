    ...
    for (let i = 0; i < this.props.question_options.length; i++) {
      ...
      components.push(
        <div style={{marginBottom: "3px"}}>
          <input type="radio" id={this.props.question_id + option["value"]} name={this.props.question_id} value={option["value"]} onChange={this.handleChange} checked={this.props.answer == option["value"] && true || this.props.answer != option["value"] && false} />
